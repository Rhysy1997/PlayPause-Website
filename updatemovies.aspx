  ...
  <ul class="media-list">
    <li class="media col-sm-12">
      <div class="media-left">
          <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="Movie" DataValueField="ID">
          </asp:DropDownList>
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [ID], [Movie] FROM [Moviesstock]"></asp:SqlDataSource>
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Moviesstock] WHERE [ID] = ?" InsertCommand="INSERT INTO [Moviesstock] ([ID], [Genre], [Movie], [Image]) VALUES (?, ?, ?, ?)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Moviesstock] WHERE ([ID] = ?)" UpdateCommand="UPDATE [Moviesstock] SET [Genre] = ?, [Movie] = ?, [Image] = ? WHERE [ID] = ?">
              <DeleteParameters>
              ...
              <SelectParameters>
                  <asp:FormParameter DefaultValue="0" FormField="DropDownList1" Name="ID" Type="Int32" />
              </SelectParameters>
              <UpdateParameters>
                  <asp:Parameter Name="Genre" Type="String" />
                  <asp:Parameter Name="Movie" Type="String" />
